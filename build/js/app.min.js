/*! Made by Oliver Beattie. Built 2019-02-11 */

(function(){$(function(){var a,b,c,d,e,f,g,h,i,j;return f=[],e=new google.maps.Map($("#map")[0],{zoom:4,center:new google.maps.LatLng(51.500358,-.125506),mapType:google.maps.MapTypeId.ROADMAP,disableDefaultUI:!0,mapTypeControl:!0,zoomControl:!0,mapTypeControlOptions:{style:google.maps.MapTypeControlStyle.DROPDOWN_MENU,position:google.maps.ControlPosition.TOP_RIGHT},zoomControlOptions:{position:google.maps.ControlPosition.TOP_RIGHT}}),c={mi:3963.1676,km:6378.1,ft:20925524.9,mt:6378100,in:251106299,yd:6975174.98,fa:3487587.49,na:3443.89849,ch:317053.408,rd:1268213.63,fr:31705.3408},g=function(){return this.setMap(null)},b=function(){var a,b,c;for(a=0,b=f.length;a<b;a++)c=f[a],c.setMap(null);return f=[]},d=function(){return navigator.geolocation?navigator.geolocation.getCurrentPosition(function(a){var b,d,f,g,h;return d={lat:a.coords.latitude,lng:a.coords.longitude},e.setCenter(d),b={position:d,map:e,draggable:!0},new google.maps.Marker(b),g=$("#unitSelector"),h=$("option",g).eq(g[0].selectedIndex).val(),f=parseFloat(document.getElementById("radiusInput").value),f=f/c[h]*c.mt,new google.maps.Circle({center:d,clickable:!0,draggable:!1,editable:!1,fillColor:"#004de8",fillOpacity:.27,map:e,radius:f,strokeColor:"#004de8",strokeOpacity:.62,strokeWeight:1})},function(){return handleLocationError(!0,infoWindow,e.getCenter())}):handleLocationError(!1,infoWindow,e.getCenter())},a=function(b){var d,f,h,i;return h=$("#unitSelector"),i=$("option",h).eq(h[0].selectedIndex).val(),f=parseFloat(document.getElementById("radiusInput").value),f=f/c[i]*c.mt,d=new google.maps.Circle({center:b.latLng,clickable:!0,draggable:!1,editable:!1,fillColor:"#004de8",fillOpacity:.27,map:e,radius:f,strokeColor:"#004de8",strokeOpacity:.62,strokeWeight:1}),google.maps.event.addListener(d,"rightclick",g),google.maps.event.addListener(d,"click",a)},google.maps.event.addListener(e,"click",a),i=document.getElementById("searchInput"),$(i.form).on({submit:function(){return!1}}),h=new google.maps.places.SearchBox(i),google.maps.event.addListener(h,"places_changed",function(){var a;b(),null!=(a=h.getPlaces()[0])&&(null!=a.geometry.viewport?(e.fitBounds(a.geometry.viewport),e.panToBounds(a.geometry.viewport)):e.setCenter(a.geometry.location),f.push(new google.maps.Marker({position:a.geometry.location,map:e,title:a.name,clickable:!1})))}),j=function(){var a,b,c,d;return a=e.getCenter(),b={lat:_.round(a.lat(),6).toString(),lng:_.round(a.lng(),6).toString(),z:e.getZoom().toString(),u:$("#unitSelector").val(),r:$("#radiusInput").val()},b.r||delete b.r,d=new URI,d.setQuery(b),null!=(c=window.history)&&"function"==typeof c.replaceState?c.replaceState(null,null,d.toString()):void 0},google.maps.event.addListener(e,"bounds_changed",_.debounce(j,200)),google.maps.event.addListener(e,"zoom_changed",j),$("#unitSelector, #radiusInput").on("change",j),$(window).on("hashchange",function(a){var b,c,f,g,h;if(g=(new URI).query(!0),d(),c=e.getCenter(),b=[c.lat(),c.lng()],f=[b[0],b[1]],null!=g.lat&&(f[0]=parseFloat(g.lat)),null!=g.lng&&(f[1]=parseFloat(g.lng)),0===$.grep(f,isNaN).length&&e.setCenter({lat:f[0],lng:f[1]}),null!=g.z&&(h=parseInt(g.z,10),isNaN(h)||e.setZoom(h)),null!=g.r&&$("#radiusInput").val(g.r),null!=g.u)return $("#unitSelector").val(g.u)}).triggerHandler("hashchange")})}).call(this),/*! URI.js v1.15.1 http://medialize.github.io/URI.js/ */
