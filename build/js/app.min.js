/*! Made by Oliver Beattie. Built 2019-02-15 */

(function(){$(function(){var a,b,c,d,e,f,g,h,i;return f=[],e=new google.maps.Map($("#map")[0],{zoom:4,center:new google.maps.LatLng(51.500358,-.125506),mapType:google.maps.MapTypeId.ROADMAP,disableDefaultUI:!0,mapTypeControl:!0,zoomControl:!0,mapTypeControlOptions:{style:google.maps.MapTypeControlStyle.DROPDOWN_MENU,position:google.maps.ControlPosition.TOP_RIGHT},zoomControlOptions:{position:google.maps.ControlPosition.TOP_RIGHT}}),c={mi:3963.1676,km:6378.1,ft:20925524.9,mt:6378100,in:251106299,yd:6975174.98,fa:3487587.49,na:3443.89849,ch:317053.408,rd:1268213.63,fr:31705.3408},function(){return this.setMap(null)},b=function(){var a,b,c;for(a=0,b=f.length;a<b;a++)c=f[a],c.setMap(null);return f=[]},d=function(){return navigator.geolocation?navigator.geolocation.getCurrentPosition(function(b){var d,f,g,h,i,j,k,l,m,n;return k={lat:b.coords.latitude,lng:b.coords.longitude},e.setCenter(k),j={position:k,map:e,draggable:!0},h=new google.maps.Marker(j),e.setZoom(17),e.panTo(h.position),m=$("#unitSelector"),n=$("option",m).eq(m[0].selectedIndex).val(),l=parseFloat(document.getElementById("radiusInput").value),l=l/c[n]*c.mt,i=new google.maps.Circle({center:k,clickable:!0,draggable:!1,editable:!1,fillColor:"#004de8",fillOpacity:.27,map:e,radius:l,strokeColor:"#004de8",strokeOpacity:.62,strokeWeight:1}),f=document.getElementById("lat"),g=document.getElementById("lng"),d=document.getElementById("dennis"),google.maps.event.addListener(h,"dragend",function(b){if(a(b,i)){if(f.value=b.latLng.lat(),g.value=b.latLng.lng(),d)return d.style.display="none"}else if(f.value="",g.value="",d)return d.style.display=""}),google.maps.event.addListener(h,"dragstart",function(b){if(a(b,i)){if(f.value=b.latLng.lat(),g.value=b.latLng.lng(),d)return d.style.display="none"}else if(f.value="",g.value="",d)return d.style.display=""})},function(){return handleLocationError(!0,infoWindow,e.getCenter())}):handleLocationError(!1,infoWindow,e.getCenter())},a=function(a,b){return b.getBounds().contains(a.latLng)},function(a){var b,d,f;return d=$("#unitSelector"),f=$("option",d).eq(d[0].selectedIndex).val(),b=parseFloat(document.getElementById("radiusInput").value),b=b/c[f]*c.mt,new google.maps.Circle({center:a.latLng,clickable:!0,draggable:!1,editable:!1,fillColor:"#004de8",fillOpacity:.27,map:e,radius:b,strokeColor:"#004de8",strokeOpacity:.62,strokeWeight:1})},h=document.getElementById("searchInput"),$(h.form).on({submit:function(){return!1}}),g=new google.maps.places.SearchBox(h),google.maps.event.addListener(g,"places_changed",function(){var a;b(),null!=(a=g.getPlaces()[0])&&(null!=a.geometry.viewport?(e.fitBounds(a.geometry.viewport),e.panToBounds(a.geometry.viewport)):e.setCenter(a.geometry.location),f.push(new google.maps.Marker({position:a.geometry.location,map:e,title:a.name,clickable:!1})))}),i=function(){var a,b,c,d;return a=e.getCenter(),b={lat:_.round(a.lat(),6).toString(),lng:_.round(a.lng(),6).toString(),z:e.getZoom().toString(),u:$("#unitSelector").val(),r:$("#radiusInput").val()},b.r||delete b.r,d=new URI,d.setQuery(b),null!=(c=window.history)&&"function"==typeof c.replaceState?c.replaceState(null,null,d.toString()):void 0},google.maps.event.addListener(e,"bounds_changed",_.debounce(i,200)),google.maps.event.addListener(e,"zoom_changed",i),$("#unitSelector, #radiusInput").on("change",i),$(window).on("hashchange",function(a){var b,c,f,g,h;if(g=(new URI).query(!0),d(),c=e.getCenter(),b=[c.lat(),c.lng()],f=[b[0],b[1]],null!=g.lat&&(f[0]=parseFloat(g.lat)),null!=g.lng&&(f[1]=parseFloat(g.lng)),0===$.grep(f,isNaN).length&&e.setCenter({lat:f[0],lng:f[1]}),null!=g.z&&(h=parseInt(g.z,10),isNaN(h)||e.setZoom(h)),null!=g.r&&$("#radiusInput").val(g.r),null!=g.u)return $("#unitSelector").val(g.u)}).triggerHandler("hashchange")})}).call(this),/*! URI.js v1.15.1 http://medialize.github.io/URI.js/ */
