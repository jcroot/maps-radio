/*! Made by Oliver Beattie. Built 2019-02-12 */

(function(){$(function(){var a,b,c,d,e,f,g,h,i,j,k;return g=[],f=new google.maps.Map($("#map")[0],{zoom:4,center:new google.maps.LatLng(51.500358,-.125506),mapType:google.maps.MapTypeId.ROADMAP,disableDefaultUI:!0,mapTypeControl:!0,zoomControl:!0,mapTypeControlOptions:{style:google.maps.MapTypeControlStyle.DROPDOWN_MENU,position:google.maps.ControlPosition.TOP_RIGHT},zoomControlOptions:{position:google.maps.ControlPosition.TOP_RIGHT}}),d={mi:3963.1676,km:6378.1,ft:20925524.9,mt:6378100,in:251106299,yd:6975174.98,fa:3487587.49,na:3443.89849,ch:317053.408,rd:1268213.63,fr:31705.3408},h=function(){return this.setMap(null)},c=function(){var a,b,c;for(a=0,b=g.length;a<b;a++)c=g[a],c.setMap(null);return g=[]},e=function(){return navigator.geolocation?navigator.geolocation.getCurrentPosition(function(b){var c,e,g,h,i,j,k;return h={lat:b.coords.latitude,lng:b.coords.longitude},f.setCenter(h),g={position:h,map:f,draggable:!0},c=new google.maps.Marker(g),f.setZoom(17),f.panTo(c.position),j=$("#unitSelector"),k=$("option",j).eq(j[0].selectedIndex).val(),i=parseFloat(document.getElementById("radiusInput").value),i=i/d[k]*d.mt,e=new google.maps.Circle({center:h,clickable:!0,draggable:!1,editable:!1,fillColor:"#004de8",fillOpacity:.27,map:f,radius:i,strokeColor:"#004de8",strokeOpacity:.62,strokeWeight:1}),google.maps.event.addListener(c,"dragend",function(b){return a(b,e)?console.log("entro"):console.log("fuera")}),google.maps.event.addListener(c,"dragstart",function(b){return a(b,e)?console.log("entro"):console.log("fuera")})},function(){return handleLocationError(!0,infoWindow,f.getCenter())}):handleLocationError(!1,infoWindow,f.getCenter())},a=function(a,b){return b.getBounds().contains(a.latLng)},b=function(a){var c,e,g,i;return g=$("#unitSelector"),i=$("option",g).eq(g[0].selectedIndex).val(),e=parseFloat(document.getElementById("radiusInput").value),e=e/d[i]*d.mt,c=new google.maps.Circle({center:a.latLng,clickable:!0,draggable:!1,editable:!1,fillColor:"#004de8",fillOpacity:.27,map:f,radius:e,strokeColor:"#004de8",strokeOpacity:.62,strokeWeight:1}),google.maps.event.addListener(c,"rightclick",h),google.maps.event.addListener(c,"click",b)},google.maps.event.addListener(f,"click",b),j=document.getElementById("searchInput"),$(j.form).on({submit:function(){return!1}}),i=new google.maps.places.SearchBox(j),google.maps.event.addListener(i,"places_changed",function(){var a;c(),null!=(a=i.getPlaces()[0])&&(null!=a.geometry.viewport?(f.fitBounds(a.geometry.viewport),f.panToBounds(a.geometry.viewport)):f.setCenter(a.geometry.location),g.push(new google.maps.Marker({position:a.geometry.location,map:f,title:a.name,clickable:!1})))}),k=function(){var a,b,c,d;return a=f.getCenter(),b={lat:_.round(a.lat(),6).toString(),lng:_.round(a.lng(),6).toString(),z:f.getZoom().toString(),u:$("#unitSelector").val(),r:$("#radiusInput").val()},b.r||delete b.r,d=new URI,d.setQuery(b),null!=(c=window.history)&&"function"==typeof c.replaceState?c.replaceState(null,null,d.toString()):void 0},google.maps.event.addListener(f,"bounds_changed",_.debounce(k,200)),google.maps.event.addListener(f,"zoom_changed",k),$("#unitSelector, #radiusInput").on("change",k),$(window).on("hashchange",function(a){var b,c,d,g,h;if(g=(new URI).query(!0),e(),c=f.getCenter(),b=[c.lat(),c.lng()],d=[b[0],b[1]],null!=g.lat&&(d[0]=parseFloat(g.lat)),null!=g.lng&&(d[1]=parseFloat(g.lng)),0===$.grep(d,isNaN).length&&f.setCenter({lat:d[0],lng:d[1]}),null!=g.z&&(h=parseInt(g.z,10),isNaN(h)||f.setZoom(h)),null!=g.r&&$("#radiusInput").val(g.r),null!=g.u)return $("#unitSelector").val(g.u)}).triggerHandler("hashchange")})}).call(this),/*! URI.js v1.15.1 http://medialize.github.io/URI.js/ */
